<template>
  <div>
        ...
        <el-table-column type="expand">
          <template slot-scope="scope">
            ...
            >
              <!-- 一级权限 -->
              <el-col :span="5">
                <el-tag closable @close="removeRight(scope.row.id, item.id)">
                  {{ item.authName }}
                </el-tag>
              </el-col>
              <!-- 二级三级权限 -->
                ...
                >
                  <el-col :span="6">
                    <el-tag
                      closable
                      type="success"
                      @close="removeRight(scope.row.id, subItem.id)"
                  ...
                  <el-col :span="18">
                    <el-tag
                      ...
                      :key="third.id"
                      @close="removeRight(scope.row.id, third.id)"
    ...
    <el-dialog
      ...
      @close="resetField"
    >
      <el-form ref="addRole" :model="role" label-width="80px">
